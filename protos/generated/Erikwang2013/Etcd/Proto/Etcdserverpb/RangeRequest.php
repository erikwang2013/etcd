...
class RangeRequest extends \Google\Protobuf\Internal\Message
{
     ...
     */
    protected $min_create_revision = 0;
    /**
     ...
     */
    protected $max_create_revision = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Erikwang2013\Etcd\Proto\Etcdserverpb\RangeRequest\SortOrder::class);
        $this->sort_order = $var;
    ...
    {
        GPBUtil::checkEnum($var, \Erikwang2013\Etcd\Proto\Etcdserverpb\RangeRequest\SortTarget::class);
